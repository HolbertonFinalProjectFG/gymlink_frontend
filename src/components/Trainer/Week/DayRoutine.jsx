...
import { removeDayOfWeek } from '../../../store'

export const DayRoutine = ({idx, isLast}) => {
  ...
  return (
    <div>
      ...
      <div className="w-full h-fit min-h-[10rem] relative p-10 flex flex-col items-center justify-center border-4 border-light-secondary rounded-xl">
        <button onClick={() => dispatch(removeDayOfWeek())} className={`${isLast ? 'flex' : 'hidden'} items-center justify-center absolute top-3 right-3 bg-light-primary text-light-backg w-10 h-10 p-2 rounded-xl`}>
