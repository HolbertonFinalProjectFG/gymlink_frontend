...
export const AddNew = ({fnc, long}) => {

  return (
    <li className={`${long ? 'w-full' : 'w-[50%]'} h-fit min-h-[10rem] flex flex-col items-center justify-center border-4 border-light-primary border-dotted rounded-xl`}>
